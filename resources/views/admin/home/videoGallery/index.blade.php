...
<div class="page-wrapper">
    <div class="content container-fluid">
                ...
                <div class="card mb-0">
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            <a href="{{route('add.video.gallery')}}"><button class="btn btn-success"
                                    style="margin-top: -25px;">Add Gallery Video</button></a>
                        </div>
                    </div>
                    <div class="card-body">
        ...
        <div class="float-right">{{ $videos->links() }}</div>
    </div>
</div>
@endsection
